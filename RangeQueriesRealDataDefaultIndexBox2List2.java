...
public class RangeQueriesRealDataDefaultIndexBox2List2 {
	 ...
	 public void test1() throws Exception { 
		 // Mongodb initialization parameters.
	        ...
	        double maxlat=90d;
	        double minlat=-90d;
	        String[] keywords = {"hashtags","tag","tweet "};
	       ...
	       FileOutputStream outputStream = new FileOutputStream("results_real_def_q5.txt");
	    ...
	    public static void main(String[] args) throws Exception {
	    	...
	    	org.junit.runner.JUnitCore.main("gr.unipi.geotextualindexing.sfc.RealData.RangeQueriesRealDataDefaultIndexBox2List2");            
	 }
