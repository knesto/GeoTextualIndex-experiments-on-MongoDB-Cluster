...
public class RangeQueriesRealDataDefaultIndexBox2List3 {
	
	 @Test
	 public void test1() throws Exception { 
		 // Mongodb initialization parameters.
	        int port_no = 27017;
	        String host_name = "localhost", db_name = "mongodb", db_coll_name = "real_data_default_index";
	        //hilbertcollection
	        ...
	        long max = 1L << bits;
	        double lon1= -124.67285156250001;
	        double lat1= 37.16031654673677;
	        double lon2= -122.25585937500001;
	        double lat2=  37.47530995561875;
	        double maxlon=180d;
	        double minlon=-180d;
	        double maxlat=90d;
	        double minlat=-90d;
	        String[] keywords = {"thanks","happy","birthday"};
	       ...
	       FileOutputStream outputStream = new FileOutputStream("results_real_def_q6.txt");
	    ...
	    public static void main(String[] args) throws Exception {
	    	...
	    	org.junit.runner.JUnitCore.main("gr.unipi.geotextualindexing.sfc.RealData.RangeQueriesRealDataDefaultIndexBox2List3");            
	 }
