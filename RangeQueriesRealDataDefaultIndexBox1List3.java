...
public class RangeQueriesRealDataDefaultIndexBox1List3 {
	 ...
	 public void test1() throws Exception { 
		 // Mongodb initialization parameters.
	        ...
	        long max = 1L << bits;
	        double lon1= -121.640625;
	        double lat1= 33.87220829920497;
	        double lon2= -118.125;
	        double lat2=  33.87041555094183;
	        double maxlon=180d;
	        double minlon=-180d;
	        double maxlat=90d;
	        double minlat=-90d;
	       ...
	       FileOutputStream outputStream = new FileOutputStream("results_real_def_q3.txt");
	    ...
	    public static void main(String[] args) throws Exception {
	    	...
	    	org.junit.runner.JUnitCore.main("gr.unipi.geotextualindexing.sfc.RealData.RangeQueriesRealDataDefaultIndexBox1List3");            
	 }
